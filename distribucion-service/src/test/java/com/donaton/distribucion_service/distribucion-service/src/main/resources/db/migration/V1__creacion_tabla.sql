...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2026 a las 04:05:27
...
--
-- Base de datos: `donaton_distribucion`
--
...
CREATE TABLE `distribucion` (
                                ...
                                `cantidad_entregada` int(100) NOT NULL,
                                `id_emergencia` int(100) NOT NULL,
                                `id_beneficiario` int(100) NOT NULL,
                                `id_donacion` int(100) NOT NULL
